    ...
    <div className="relative bg-white pt-24 pb-16 sm:pt-32 lg:overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
          <div className={`max-w-md mx-auto lg:max-w-none lg:mx-0 lg:col-start-1 transition-all duration-700 ${
          ...
          <div className={`mt-12 lg:m-0 lg:relative transition-all duration-700 delay-300 ${
